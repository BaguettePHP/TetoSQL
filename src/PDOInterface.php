...
interface PDOInterface
{
     ...
     *
     * @link   http://php.net/manual/pdo.errorcode.php
     ...
     *
     * @link   http://php.net/manual/pdo.errorinfo.php
     ...
     *
     * @link   http://php.net/manual/pdo.getavailabledrivers.php
     * @return string[]
     */
     ...
     * @param  string The SQL statement to prepare and execute.
     ...
     *
     * @link   http://php.net/manual/pdo.quote.php
     ...
     * Set an attribute
     *
     * @link   http://php.net/manual/pdo.setattribute.php
     * @param  int   $attribute One of the PDO::ATTR_* constants.
     * @param  mixed $value
